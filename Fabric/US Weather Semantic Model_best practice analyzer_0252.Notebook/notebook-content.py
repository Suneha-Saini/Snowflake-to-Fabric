...
dataset = "US Weather Semantic Model" # Enter the name or ID of the semantic model
workspace = "Development_workspace" # Enter the workspace name or ID in which the semantic model exists
